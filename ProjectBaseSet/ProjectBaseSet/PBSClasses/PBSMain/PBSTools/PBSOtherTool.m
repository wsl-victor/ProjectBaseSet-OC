...
#import "PBSOtherTool.h"

@implementation PBSOtherTool
...
//将字典对象转换为 JSON 字符串
+ (NSString *)jsonDicPrettyStringEncoded:(NSDictionary *)dictionary{
...
//将数组对象转换为 JSON 字符串
+ (NSString *)jsonArrPrettyStringEncoded:(NSArray *)array{
